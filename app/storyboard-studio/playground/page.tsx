...
import type { MaskDot, BubbleType, TailMode, TailDir, FontWeight, FontStyle, FontFamily, Bubble, DragMode } from "../shared/canvas-types";
import { clamp, jitter, estimateFontSize, bubbleEllipse, roughEllipsePath, tailPath, rectTailPath, rectOutlinePathWithGap, cloudPath, burstPoints, makeId } from "../shared/canvas-helpers";
import { TransformControls, ResizeHandles, BubbleSVG } from "../shared/canvas-components";
...
// Types and helpers are imported from ../shared/canvas-types and ../shared/canvas-helpers
// Components (TransformControls, ResizeHandles, BubbleSVG) are imported from ../shared/canvas-components

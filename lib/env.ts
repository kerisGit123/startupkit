...
const EnvSchema = z.object({
  ...
  STARTER_MONTHLY_PRICE_ID: z.string().optional(),
  PRO_MONTHLY_PRICE_ID: z.string().optional(),
  STARTER_YEARLY_PRICE_ID: z.string().optional(),
  PRO_YEARLY_PRICE_ID: z.string().optional(),
